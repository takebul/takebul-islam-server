<div align="center">
  ...
  <img src="public/images/readme-banner.svg" alt="Takebul Islam — Full-Stack Developer Banner" width="100%" />
  ...
  <p align="center">
    ...
    <a href="https://gsap.com">
      <img src="https://img.shields.io/badge/GSAP%203-88CE02?style=for-the-badge&logo=greensock&logoColor=white" alt="GSAP 3" />
    </a>
  </p>
...
<p align="center">
  <img src="public/images/projects/startupforge.png" alt="StartupForge Interface Preview" width="100%" style="border-radius: 8px; border: 1px solid #1e293b;" />
</p>
...
<p align="center">
  <img src="public/images/projects/tutorbook.png" alt="TutorBook Interface Preview" width="100%" style="border-radius: 8px; border: 1px solid #1e293b;" />
</p>
...
<p align="center">
  <img src="public/images/projects/mangobooks.png" alt="Mango Books Interface Preview" width="100%" style="border-radius: 8px; border: 1px solid #1e293b;" />
</p>
...
```mermaid
graph TD
    Client["Next.js 16 Frontend App (App Router + React 19)"]
    Canvas["Interactive HTML5 Constellation Canvas"]
    Kinetic["Lenis Smooth Scroll + GSAP Ticker (60 FPS)"]
    Admin["Protected Headless CMS Dashboard (/dashboard)"]
    
    API["Express.js REST Microservice (Port 8541)"]
    DB[("MongoDB Atlas Cloud Database")]
    ImgBB["ImgBB Cloud Media Storage API"]
    
    Client --> Kinetic
    Client --> Canvas
    Client --> Admin
    
    Client <-->|RESTful JSON Endpoints| API
    Admin -->|Upload Media| ImgBB
    API <-->|Native Driver Operations| DB
```
